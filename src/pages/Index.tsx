...
const Index = () => {
  ...
  return <div className="min-h-screen">
      ...
      {/* Hero Section */}
      <section className="absolute inset-0 flex items-start pt-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-background/50 via-background/70 to-background">
        <div className="max-w-7xl mx-auto w-full">
          <div className="text-center animate-fade-in backdrop-blur-md bg-background/80 rounded-lg p-8 shadow-lg">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-foreground mb-6 drop-shadow-sm">
              Your <span className="text-primary font-extrabold">Trusted Source</span> for
              <br />Supplement Reviews
            </h1>
            <p className="text-xl text-foreground/90 mb-8 max-w-3xl mx-auto font-medium">Get honest, science-backed reviews of the latest fitness supplements. Make informed decisions for your fitness journey with our expert analysis.</p>
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-20 bg-background">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((feature, index) => <div key={index} className="text-center p-6 rounded-lg bg-muted/50 hover:bg-muted/70 hover:shadow-card transition-all duration-300 animate-fade-in" style={{
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-background rounded-lg p-6 shadow-card hover:shadow-hero transition-all duration-300">
              ...
              <h3 className="font-semibold text-lg mb-2 text-foreground">Premium Whey Protein</h3>
              <div className="flex items-center mb-3">
                {Array.from({
                length: 5
              }, (_, i) => <Star key={i} className="w-4 h-4 text-yellow-400 fill-current" />)}
                <span className="ml-2 text-sm text-foreground/70 font-medium">4.8/5</span>
              </div>
            ...
            <div className="bg-background rounded-lg p-6 shadow-card hover:shadow-hero transition-all duration-300">
              ...
              <h3 className="font-semibold text-lg mb-2 text-foreground">Pre-Workout Energy</h3>
              <div className="flex items-center mb-3">
                {Array.from({
                length: 5
              }, (_, i) => <Star key={i} className={`w-4 h-4 ${i < 4 ? "text-yellow-400 fill-current" : "text-gray-300"}`} />)}
                <span className="ml-2 text-sm text-foreground/70 font-medium">4.2/5</span>
              </div>
              <p className="text-foreground/80 text-sm mb-4">
            ...
            <div className="bg-background rounded-lg p-6 shadow-card hover:shadow-hero transition-all duration-300">
              ...
              <h3 className="font-semibold text-lg mb-2 text-foreground">Vitamin D3</h3>
              <div className="flex items-center mb-3">
                {Array.from({
                length: 5
              }, (_, i) => <Star key={i} className="w-4 h-4 text-yellow-400 fill-current" />)}
